...
namespace QuoteReport.Service.Tests
{
    ...
    {
        [TestCase(500000,true, "residential@test.com", 
            "The quote for residential@test.com property Value 500000." +
            " Total is 27500, including StampDuty - 25000 and Legal Fee - 2500")]
        [TestCase(500000,false, 
            "nonresidential@test.com", 
            "The quote for nonresidential@test.com property Value 500000. " +
            "Total is 55000, including StampDuty - 50000 and Legal Fee - 5000")]
        public void GenerateQuoteReportService_Create_Reports(double value, bool residential, 
